...
from apply_form.fill_multiple_choice_fields import fill_multiple_choice_fields, _process_select_element
...
class TestFillMultipleChoiceFields:
    ...
    async def test_fill_multiple_choice_fields_multiple_selects(self, mock_process_select):
        ...
        mock_process_select.assert_any_call(mock_page, mock_select1, multiple_choice_fields)
        mock_process_select.assert_any_call(mock_page, mock_select2, multiple_choice_fields)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            MatchResult(match_percentage=0, analysis="No overlap."),
            0,
            "No overlap.",
        ),
        (
            MatchResult(match_percentage=100, analysis="Perfect fit."),
            100,
            "Perfect fit.",
        ),
    ],
...
def test_calculate_skill_match_logs_final_info(
    ...
    mock_response = MatchResult(match_percentage=95, analysis="Excellent.")
